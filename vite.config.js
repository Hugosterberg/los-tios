...
export default defineConfig({
  ...
  plugins: [
    base44({
      // Support for legacy code that imports the hosted SDK with @/integrations, @/entities, etc.
      // can be removed if the code has been updated to use the new SDK package imports
