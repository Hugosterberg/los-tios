            ...
            <div className="max-w-7xl mx-auto px-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  <a href="#menu" className="text-[#1a1a1a] text-xs font-bold bg-black/10 hover:bg-black/20 px-3 py-1.5 rounded-full transition-colors">Menú</a>
                  <a href="#eventos" className="text-[#1a1a1a] text-xs font-bold bg-black/10 hover:bg-black/20 px-3 py-1.5 rounded-full transition-colors">Eventos</a>
                  <a href="#about" className="text-[#1a1a1a] text-xs font-bold bg-black/10 hover:bg-black/20 px-3 py-1.5 rounded-full transition-colors">Sobre nosotros</a>
                  <a href="https://wa.me/529541307386" target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-1 text-[#1a1a1a] text-xs font-bold bg-black/10 hover:bg-black/20 px-3 py-1.5 rounded-full transition-colors">
                    ...
                    <span className="hidden sm:inline">+52 954 130 7386</span>
                  </a>
                </div>
              </div>
            </div>
