...
export function getPublicRestaurantCopy(locale) {
  const es = {
    ...
    featuredTitle: "Del horno",
    featuredSubtitle: "Una muestra de nuestras pizzas; abajo está el menú completo y el carrito.",
    featuredSeeAll: "Ver menú completo →",
    featuredLoading: "Cargando…",
    featuredEmpty: "El menú está cargando. Vuelve en un momento.",
    ...
    reviewsSubtitle: "Una selección de reseñas en Google (5 estrellas).",
    ...
    fullMenuSectionTitle: "Menú completo y pedido",
  ...
  const en = {
    ...
    featuredTitle: "From the oven",
    featuredSubtitle: "A taste of our line; scroll for the full menu and cart.",
    featuredSeeAll: "See full menu →",
    featuredLoading: "Loading…",
    featuredEmpty: "Menu loading. Check back in a moment.",
    ...
    reviewsSubtitle: "A selection of five-star Google reviews.",
    ...
    fullMenuSectionTitle: "Full menu & order",
