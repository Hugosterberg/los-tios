...
export default function Layout({ children, currentPageName }) {
  ...
  const navItems = [
    ...
    { name: "Reservaciones", url: createPageUrl("Reservations"), icon: Calendar },
    { name: "Gastos", url: createPageUrl("Expenses"), icon: Receipt },
    { name: "Cuenta Empresa", url: createPageUrl("CompanyAccount"), icon: Wallet },
