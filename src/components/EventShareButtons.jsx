...
export default function EventShareButtons({ title, text, url, lang = "es" }) {
  ...
  // Native share (works great on mobile for Instagram Stories, WhatsApp, etc.)
  ...
  const links = [
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 24 24" fill="white">
    ...
    },
    {
      ...
      href: `https://www.facebook.com/sharer/sharer.php?u=${shareUrlEncoded}&quote=${shareTextEncoded}`,
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 24 24" fill="white">
    ...
    },
    {
      ...
      href: `https://twitter.com/intent/tweet?text=${shareTextEncoded}&url=${shareUrlEncoded}`,
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className={iconClass} viewBox="0 0 24 24" fill="white">
  ...
  return (
    <div className="mt-4 pt-4 border-t border-white/10">
      ...
      <div className="flex flex-wrap gap-2 items-center">
        ...
        {/* Native share button (shown on mobile — best for Instagram Stories, WhatsApp etc.) */}
        {hasNativeShare && (
          <button
            onClick={handleNativeShare}
            title={lang === "en" ? "Share" : "Compartir"}
        ...
        {links.map((link) => (
          <a
            ...
            title={link.label}
            className={`inline-flex items-center justify-center w-7 h-7 rounded-full transition-all ${link.color}`}
          >
            {link.icon}
          </a>
        ))}
